...
// MongoClient.connect('mongodb://localhost:27017/city', function(err, db) {

// 	var collection = db.collection('tickets');

// 	function addRouteInformationToCollection(routeLatLng) {

// 		console.log('adding route information');
// 		console.log(JSON.stringify(routeLatLng, null, 4));

// 		var routeName = routeLatLng.route;
// 		var query = {Route: routeName};
// 		console.log(query);
...
// 			var nextRouteLatLng = routeLatLngs.pop();
// 			if (nextRouteLatLng) {

// 				addRouteInformationToCollection(routeLatLng);
// 			} else {
...
// 	var nextRouteLatLng = routeLatLngs.pop();
// 	addRouteInformationToCollection(nextRouteLatLng);
